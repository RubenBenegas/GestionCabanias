...
Public Class rptListadoGastos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Cabañas.rptListadoGastos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoGastos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoGastos = New rptListadoGastos
        rpt.Site = Me.Site
        Return rpt
    End Function
